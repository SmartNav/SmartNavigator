...
<div class="left-part">
	<ul id="left-nav-ul">
		<c:if test="${leftnavselect eq 1 }">
			<li><a href="${ctx }/admin/entertainment/list" id="left-nav-ul-selected">列表管理</a></li>
		</c:if>
		<c:if test="${leftnavselect ne 1 }">
			<li><a href="${ctx }/admin/entertainment/list">列表管理</a></li>
		</c:if>
		
		<c:if test="${leftnavselect eq 2 }">
		<c:if test="${leftnavselect eq 2 }">
			<li><a href="#" id="left-nav-ul-selected">添加优惠</a></li>
		</c:if>
