...
public class OtherPlaceService {
	...
	@Transactional
	public void add(String name,int level,int type,String descript,String description,double latitude,double longitude,String location,String img){
	...
	@Transactional
	public void modify(long id,String name,int level,int type,String descript,String description,double latitude,double longitude,String location,String img,boolean deleteImg){
